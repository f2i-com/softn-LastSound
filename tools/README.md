...
| `test-bundle.cjs` | The structural validation the SoftN loaders apply: `node tools/test-bundle.cjs dist/LastSound3D.softn`. |
| `sfx-lib.cjs` | The tone/noise synthesizer softn.com's demo games use for effects, kept for anyone extending the sound set. |
